    ...
    <footer className="d_footer-wrapper">
      <div className="container">
        ...
        <section className="d_newsletter-container">
          <h2 className="d_newsletter-title">
            Sign up to get latest offers & discount
          </h2>
          <p className="d_newsletter-sub">
            Get updates on new arrivals and exclusive promos directly in your
            inbox.
          </p>
          ...
          <div className="col-12 col-md-12 col-lg-6 ps-lg-5">
            <div className="d_contact-box">
              ...
              <div className="d_info-item">
                ...
                <span className="d_contact-text">
                  Poshvue Fashion, Surat, Gujarat 395007
                </span>
              </div>

              <div className="d_social-flex">
                <span className="w-100 small text-muted mb-1 d-md-block d-none">
                  FOLLOW US
                </span>

                <a
                  href="https://www.facebook.com/poshvue"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="d_social-icon"
                >
                  <Facebook size={18} />
                </a>

                <a
                  href="https://www.instagram.com/poshvue"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="d_social-icon"
                >
                ...
                <a
                  href="https://www.youtube.com/@poshvue"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="d_social-icon"
                >
