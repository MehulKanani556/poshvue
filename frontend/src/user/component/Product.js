...
export default function Product({ productId}) {
  ...
  // fetch newly added 12 products from backend
  useEffect(() => {
    let mounted = true;
  ...
  return (
    <div class="similiar-products mt-5 mb-0 container">
      <style>{`
      ...
      <div className="similiar-header">
        <h5 style={{color:"#0a2845"}}>New Product Added</h5>
      ...
      {loading ? (
        <Loader text="Loading New Product Added..." />
      ) : (
