...
exports.create = async (req, res) => {
  ...
  try {
    ...
    if (payload.couponCode) {
      ...
      const couponResult = await incrementCouponUsage(payload.couponCode);
      if (couponResult.success) {
        console.log('[Order] Coupon usage incremented:', {
          couponCode: payload.couponCode,
          usage: couponResult.usage,
          maxUses: couponResult.maxUses,
          active: couponResult.active,
          deactivated: couponResult.deactivated
        });
      } else {
        console.error('[Order] Failed to increment coupon usage:', couponResult.message);
      }
    }
